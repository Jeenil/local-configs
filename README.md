...
On a fresh WSL install, run this single command:

```bash
bash <(curl --silent --fail --show-error --location https://raw.githubusercontent.com/Jeenil/local-configs/refs/heads/main/bash/setup-wsl.sh)
```

This copies your SSH key from Windows, clones all repos, decrypts secrets, and installs all tools automatically.
